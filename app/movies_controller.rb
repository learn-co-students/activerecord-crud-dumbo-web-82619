...
def can_find_the_first_item_from_the_database_using_id
  Movie.all.find(Movie.all.first.id)
end
...
def can_be_found_updated_and_saved
  ...
  movie.update_attributes(:title => "Even Awesomer Flick")
  movie.save
end
...
def can_update_using_update_method
  ...
  movie.update_attributes(:title => "Wat, huh?")
  movie.save
end
...
def can_update_multiple_items_at_once
  ...
  Movie.all.each do |movie|
    movie.update_attributes(:title => "A Movie")
  end
end

def can_destroy_a_single_item
  Movie.create(title: "That One Where the Guy Kicks Another Guy Once")
  die = Movie.all.find do |movie|
    movie.title == "That One Where the Guy Kicks Another Guy Once"
  end
  Movie.destroy(die.id)
end
